...
(ert-deftest test-edid-get-name ()
  (let ((edid-str ""))
    (should (equal (settings--edid-get-name edid-str)
                   "ASUS PA279"))))
...
DP-3 connected (normal left inverted right x axis y axis)"))
    (let  ((monitors (settings--parse-xrandr xrandr-str)))
      (should (equal (settings--monitor-primary? (cl-first monitors))
                     t))
      (should (equal (settings--monitor-disabled? (cl-second monitors))
                     t))
      (should (equal (settings--monitor-offsetx (cl-first monitors))
                     0))
      (should (equal (settings--monitor-name (cl-first monitors))
                     "LG ULTRAFINE")))))
